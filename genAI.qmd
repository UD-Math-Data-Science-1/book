...
4. Install the [GitHub Copilot](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot) and the [GitHub Copilot chat](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot-chat) extensions for Visual Studio Code.
5. [Sign in to your GitHib account](https://itsfoss.com/vs-code-github/) in Visual Studio Code. You won't need the technical information on how to use Git or GitHub itself, but this is what unlocks access to GitHub Copilot.
