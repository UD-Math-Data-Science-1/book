...
$$
\begin{split}
    \text{CoD} & = 1 - \frac{\left(y_i - \hat{y}_i \right)^2 = \left(0+1\right)^2 + \left(2-0\right)^2 + \left(3-1\right)^2}{14/3}  \\ 
...
::::{#exm-regression-linear chapter=5 type=✍️ description="Proving linearity"}
