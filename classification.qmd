...
Supervised learning
: The training data consists of only examples that include the answer (or **label**) we expect to get. The goals are to find important effects and/or to predict labels for previously unseen examples.
...
::::{#exm-class-digits chapter=3 type=💻 description="Digit classification"}
```{python}
...
The value `digits` is a vector of labels for the digits:
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_f63ccqhd&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_nuin913e%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.1" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/numbers.jpg){.lightbox width=200px fig-align="center"}
...
Each row of the feature matrix is the feature vector of one sample, while each column is the value of a single feature over the entire dataset.

::::{#exm-class-emoji chapter=3 type=✍️ description="Feature matrix"}
Suppose that to each text message in a collection, we ascribe a vector of counts for certain emoji. The messages are

1. "lol 🤣💀"
2. "sushi nite 🐟🍚❤️❤️"
3. "worked out 💪💯"

If the emoji features to be counted are [❤️, 🤣, 💀, 💪], then the feature matrix is
...
:::{.column-margin}
![](_media/memes/generalization.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-class-traintest chapter=3 type=💻 description="Train–test split"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_j0w2wyn3&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_v29keia5%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.3" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/loans.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-class-accuracy chapter=3 type=💻 description="Testing accuracy"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_lxdc52jg&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_t02obcrn%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.4" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
**recall** 
: How often are actual *positive* cases predicted correctly? This is also called *sensitivity* or the *true positive rate*. It sets the goal as minimizing false negatives among actual positive cases.

**specificity** 
: How often are actual *negative* cases predicted correctly? This is also called the *true negative rate*. It sets the goal as minimizing false positives among actual negative cases.

**precision**
: How often are the *positive* predictions correct? This is also called *positive predictive value*. It sets the goal as minimizing false positives among positive predictions.
...
::::{#exm-class-confusion chapter=3 type=✍️ description="Classifier performance metrics"}
...
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_uz0psivl&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_om9jfaaz%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.5" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/no%20fp.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-class-metrics chapter=3 type=💻 description="Binary classifier metrics"}
...
The loan classifier has excellent recall, respectable precision, and terrible specificity, resulting in a good *F*₁ score and a mediocre balanced accuracy score.

::::

:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_xez8q895&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_6wzqn7uy%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.6" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

:::


::::{#exm-class-scores-simple chapter=3 type=✍️ description="Combined metrics"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_ef7mli52&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_znmk6o1q%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.7" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
::::{#exm-class-one-vs-rest chapter=3 type=✍️ description="Multiclass one-vs-rest"}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_hfixb8l6&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_ndcuugnt%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Section 3.2.3" style="position:absolute;top:0;left:0;width:100%;height:100%"></iframe></div></div>
</br>
![](_media/memes/confusion.jpg){.lightbox width=200px fig-align="center"}

:::

::::{#exm-class-multiclass chapter=3 type=💻 description="Multiclass metrics"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_1qocbyij&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_friq1z9o%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.9" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/car.jpg){.lightbox width=200px fig-align="center"}
...
The fundamental step is: *given feature vectors $\bfx_1,\ldots,\bfx_n$ with labels $y_1,\ldots,y_n$, partition the samples into two subsets, each of which has labels as uniform as possible.* That step is then repeated recursively on the two subsets just formed by the partition, and so on. The result is a **binary tree**, as illustrated in @fig-class-tree.
...
::::{#exm-class-tree chapter=3 type=✍️ description="Decision tree"}
In @fig-class-tree, suppose that leaf A contains [H,T,T], leaf B contains [H], and leaf C contains [H,H,T]. The query $(x_1,x_2)=(1,0)$ first goes left (since $0 <2$) and then right (since $1\not< 0$), landing in leaf C. The prediction for this query is then "H".
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src='https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_2fy3h53b&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_tqhml2ct%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D'  style="width: 304px;height: 231px;border: 0;" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" title="Definition 3.5"></iframe></div></div>
...
::::{#exm-class-gini-spread chapter=3 type=✍️ description="Gini impurity"}
...
::::{#exm-class-gini chapter=3 type=✍️ description="Gini impurity"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_6j5svtw2&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_0mt8upea%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.12" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_xw3wpe9m&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_c0kjwvze%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Section 3.3.2" style="position:absolute;top:0;left:0;width:100%;height:100%"></iframe></div></div>
...
::::{#exm-class-tree-partition chapter=3 type=✍️ description="Tree partitioning"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_e1w27rpl&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_comu53vw%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.13" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/decision%20tree.jpeg){.lightbox width=200px fig-align="center"}
...
::::{#exm-class-tree-toy chapter=3 type=💻 description="Inspecting a decision tree"}
...
# There are double red points at (9, 7). One of them is moved to (11, 3) for clarity. Find the red points at (9, 7) and move the second one:
duplicates = np.flatnonzero(
    (y == 1) & np.all(X == [9, 7], axis=1)
)
X[duplicates[1]] = [11, 3]

import seaborn as sns
df = pd.DataFrame( {"x₁":X[:,0], "x₂":X[:,1], "y":y} )
sns.scatterplot(data=df, x="x₁", y="x₂", hue="y", palette=["red", "blue"]);
plt.grid(True)
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src='https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_nqnioaq8&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_vbwcrnae%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D'  style="position:absolute;top:0;left:0;width:100%;height:100%;border:0" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" title="Example 3.15"></iframe></div></div>

:::

::::{#exm-class-tree-penguins chapter=3 type=💻 description="Tree classifier for the penguins dataset"}
We return to the penguins and fit a decision tree to the quantitative features. In order to assess the effectiveness of the tree, we use the train–test paradigm.
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_nqnioaq8&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_vbwcrnae%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.15" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
::::{#exm-class-tree-penguins-interpret chapter=3 type=💻 description="Interpreting a decision tree"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_gr3z11sh&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_vp36iol8%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.16" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/gentoo.jpg){.lightbox width=200px fig-align="center"}

:::

::: {.callout-caution}
Decision tree feature importance values are not always reliable. They are known to favor quantitative features over categorical ones, and they can be sensitive to the presence of highly correlated features.
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_w85a5am5&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_v0z39gci%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Theorem 3.1" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

:::

::::{#exm-class-distance chapter=3 type=✍️ description="Calculating distance"}
...
::::{#exm-class-knn-small chapter=3 type=✍️ description="kNN classifier"}
Here are 6 sample points, labeled blue and red, in 2-dimensional feature space:

![](_media/knn_example1.svg)

Using $\infty$-norm distance and $k=3$, find the kNN labels at the locations marked A and B.
...
:::{.column-margin}
![](_media/memes/neighbors.jpeg){.lightbox width=200px fig-align="center"}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_5gh9td14&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_gf4wz0j8%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Section 3.4.2" style="position:absolute;top:0;left:0;width:100%;height:100%"></iframe></div></div>
...
::::{#exm-class-knn chapter=3 type=💻 description="kNN classifier for the penguins dataset"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_djnpafsx&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_ev936ve7%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.19" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/label.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-class-knn-norm chapter=3 type=✍️ description="kNN sensitivity to scaling"}
...
::::{#exm-class-knn-standard chapter=3 type=💻 description="Pipeline for standardizing columns"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_swqmj45e&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_rdtwk8q9%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.20" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_new5vjt4&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_p2xcomnf%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Section 3.5" style="position:absolute;top:0;left:0;width:100%;height:100%"></iframe></div></div>

:::

::::{#exm-class-phat chapter=3 type="✍️, 💻" description="Probabilistic classifier"}
...
:::{.column-margin}
![](_media/memes/votes.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-class-prob chapter=3 type=💻 description="Probabilistic classifier for the penguins dataset"}
...
::::{#exm-class-hits chapter=3 type=💻 description="Varying decision threshold"}
...
which implies the confusion matrix
...
We can summarize these using the true positive rate (TPR), which is the recall, and the false positive rate (FPR), which is 1 minus the specificity:

$$
\text{TPR} = \dfrac{\TP}{\TP + \FN} = \dfrac{1}{1+2}, \quad \text{FPR} = \dfrac{\FP}{\FP + \TN} = \dfrac{0}{0+2}.
$$
...
$$
\text{TPR} = \dfrac{\TP}{\TP + \FN} = \dfrac{2}{2+1}, \quad \text{FPR} = \dfrac{\FP}{\FP + \TN} = \dfrac{0}{0+2}.
$$
...
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_zi41n611&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_d8954r6e%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.24" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

:::

Imagine $\theta$ as a dial that tunes the classification method. At $\theta=0$, we have maximum credulity---everybody gets a trophy! Once $\theta$ goes above 1, we have maximum skepticism---nobody's good enough to get a hit. If we turn the $\theta$ dial from infinity down to zero, each sample eventually toggles from a miss to a hit, so both the true positives and false positives can only increase along the way.
...
::::{#exm-class-roc chapter=3 type=💻 description="ROC curve"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_8amtzxkx&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_2s3wbacx%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.25" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/ROC.jpeg){.lightbox width=200px fig-align="center"}
...
The ROC curve always starts in the bottom left corner (total skepticism) and ends in the top right corner (total credulity). The ideal situation is in the top left corner of the plot, corresponding to perfect TP rate (recall) and perfect FP rate (specificity).
...
::::{#exm-class-auc chapter=3 type=💻 description="Area under ROC curve"}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_wcwz6whf&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_68nq36fa%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 3.26" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
</br>
![](_media/memes/AUC.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exr-class-partition}
(3.3) Given $x_i=i$ for $i=1,\ldots,6$, with labels
$$
...
::::{#exr-class-tree}
(3.3) For the decision tree drawn in @exm-class-tree-toy, make predictions for each of the following queries, showing the path taken through the tree for each case.
