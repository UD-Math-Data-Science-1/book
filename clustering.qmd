...
:::{.column-margin}
{{< video  https://www.dropbox.com/s/9qhqcz08ugcoobq/Section6_0.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/lp98e4bn5drn5r8/Section6_1_1.mp4?raw=1 >}}
:::

Note that $D_{ii}=0$ and $D_{ji}=D_{ij}$. 

::::{#exm-cluster-distmat-small}
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/7lfw96r67olltnu/Section6_1_2.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/hxdmolatua15skd/Section6_1_3.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/gd2nfz5oxxgqduf/Section6_2_1.mp4?raw=1 >}}
:::

The reason for the denominator is that there are $\binom{n}{2}$ distinct pairs of $n$ sample points, so we know that $0 \le \text{RI} \le 1$.
...
::::{#exm-cluster-rand}
Suppose that samples $\bfX_1,\bfX_2,\bfX_4$ are classified as blue, and $\bfX_3,\bfX_5$ are classified as red. Compute the Rand index relative to the reference classification for the clustering $C_1=\{\bfX_1,\bfX_2\}$ and $C_2=\{\bfX_3,\bfX_4,\bfX_5\}$. (Note that the actual feature vectors themselves are not important in this setting.)

:::{.solution}
Here is a table showing the buddy--stranger status for every pair in the coloring and clustering:
...
::::{#exm-cluster-ARI-blobs}
Our *blobs* dataset has a reference clustering that we take to be the gold standard. Let's create another clustering based entirely on the quadrants of the plane:
...
```
The reference clustering has three classes, and there are four quadrants. Yet we can still compare them by adjusted Rand index:
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/fj759qpo8j38wei/Example6_5.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/yxjf804d2ugayp7/Section6_2_2.mp4?raw=1 >}}
:::
...
Suppose that two clusters in one dimension are defined as $A=\{-4,-1,1\}$ and $B=\{2,6\}$. Find the silhouette values of all the samples.
...
These values are ordered as we would expect. We can also compute the silhouette scores for the quadrant-based clustering defined in @exm-cluster-ARI-blobs:
...
```
The scores for clusters labelled as 1 and 2 are pretty good and almost the same as for the original reference clustering. But the other two clusters score much more poorly separately than they did when they were considered a single cluster. 
::::

:::{.column-margin}
{{< video https://www.dropbox.com/s/icu3cmmi38cuzz7/Example6_7.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/sn7gaapl6gc7sea/Example6_8.mp4?raw=1 >}}
:::
...
::::{#exm-cluster-sil-bullseye}
The bullseye dataset has only one "cluster" that silhouette values approve of:
```{python}
X, y = bullseye_data()
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/f171zxlpriccdvq/Example6_9.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/9ay1njua14zlibj/Section6_3.mp4?raw=1 >}}
:::
...
::::{#exm-cluster-inertia}
Given the samples $-3,-2,-1,2,5,7$, find the inertia of the clustering 
$$
...
:::{.solution}
The first clustering has centroids $\mu_1=-2$, $\mu_2=14/3$. Thus, the total inertia of the first clustering is 
$$
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/d3l4ouuu6i4byxl/Section6_3_1.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/fw3had5030zediv/Example6_11.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/kvppujcih39j8xa/Example6_13.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/kybi7xus8j9b3le/Section6_4a.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/c75mj4898gfmu4o/Section6_4b.mp4?raw=1 >}}
:::
...
* Ward linkage
: The increase in inertia resulting from merging $C_i$ and $C_j$, which is equal to
$$
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/wn5rfrbym4g9j1m/Example6_14b.mp4?raw=1 >}}
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/edu4as9fwwozedo/Example6_15.mp4?raw=1 >}}
:::
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/h4as5ck4sufn45a/Example6_16.mp4?raw=1 >}}
:::

::::{#exm-cluster-penguins}
...
:::{.column-margin}
{{< video https://www.dropbox.com/s/uzu954euu5twqxh/Example6_17.mp4?raw=1 >}}
:::
...
**(a)** Using the 2-norm, calculuate the inertia, as a function of $z$, of the clustering 
$$
C_1 = \{ [z,j]: j=-3,-2,-1,1,2,3\}, \qquad C_2 = \{ [-z,j]: j=-3,-2,-1,1,2,3\}. 
$$
(This divides the sample points by the $x$-axis.)

**(b)** Using the 2-norm, calculuate the inertia, as a function of $z$, of the clustering 
$$
