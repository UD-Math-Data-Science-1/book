...
The standard iteration is known as **Lloyd's algorithm**. Starting with values for the $k$ centroids, $\bfmu_1, \ldots, \bfmu_n$, each iteration consists of two steps:
