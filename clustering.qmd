...
Our *blobs* dataset has a reference clustering shown in @fig-clustering-blobs that we take to be the gold standard. Let's create another clustering based entirely on the quadrants of the plane:
...
```
The central blob scores well, but the rings score poorly because they are not compact and ball-shaped.
::::
