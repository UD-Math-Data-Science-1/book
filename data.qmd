...
Datasets can be presented in many forms. The simplest and most universal are spreadsheets and *comma-separated value* (CSV) files. Such files can be read by pandas locally or over the web.
