...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_iur6b66n&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_4g5wf92e%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.1" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
But the conversion of `float` to `int` truncates the number, which can cause subtle bugs:
```{python}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_1ksfwja3&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_xlqh0k71%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.2" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>
![](_media/memes/float_goat.jpg){.lightbox width=200px fig-align="center"}
...
::: {.callout-important}
For numerical work in Python, the NumPy package is indispensable. We will use it often, and it is also loaded and used by most other scientifically oriented packages.
:::
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_nyqbc6h9&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_dl4fmt5h%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.3" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_g0hda6xi&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_j82sxurw%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.5" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>
![](_media/memes/vectored.jpg){.lightbox width=200px fig-align="center"}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_f06t1pv6&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_ajufykqs%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.6" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_veepu3vo&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_oaqyfz03%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.7" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_xqgr0oc8&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_i89aw75a%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.8" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_nhk4pa65&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_4p1k1qe7%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.9" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
<br></br>

![](_media/memes/slicing.jpg){.lightbox width=200px fig-align="center"}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_sb1cwatu&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_4lqllzj4%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.10" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>

![](_media/memes/reduced.jpg){.lightbox width=200px fig-align="center"}
...
#| echo: false
import pandas as pd
pd.get_dummies(["Curly", "Moe", "Curly", "Larry", "Shemp", "Moe"])
```
...
#| echo: false
import pandas as pd
pd.get_dummies(["Curly", "Moe", "Curly", "Larry", "Shemp", "Moe"], drop_first=True)
```
...
:::{.column-margin}
![](_media/memes/dummies.jpg){.lightbox width=200px fig-align="center"}
:::
...
The most straightforward way to represent an image is as a 3D array of values representing intensities of red, green and blue in each pixel. Sometimes it might be preferable to represent the image by a vector of statistics about these values, or by presence or absence of detected objects, etc.
...
::::{#exm-data-series chapter=1 description="Series" type=✍️}
...
::::{#exm-data-series-create chapter=1 description="Series in pandas" type=💻}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_pfydzfw6&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_tz257fbz%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.14" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
::::{#exm-data-series-operate chapter=1 description="Operations on series" type=💻}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_51folnr4&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_18nwq9a8%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.15" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
::::{#exm-data-frames-create chapter=1 description="Series and frames in pandas" type=💻}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_6i5fwhjv&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_3ljcsf6v%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.16" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>

![](_media/memes/say_line.jpeg){.lightbox width=200px fig-align="center"}
...
::::{#exm-data-frames-operate chapter=1 description="Operations on data frames" type=💻}
We continue with the definitions of `simpsons` in @exm-data-frames-create:
...
For a more thorough demonstration of operations on data frames, look at the [pandas user guide](https://pandas.pydata.org/docs/user_guide/basics.html). There is also an [exhaustive list](https://pandas.pydata.org/docs/reference/frame.html) of relevant functions in the pandas documentation.
...
::::{#exm-data-read chapter=1 description="Importing CSV data" type=💻}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_mrq75g07&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_rlr9wspu%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.18" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>

![](_media/memes/mad_men.jpg){.lightbox width=200px fig-align="center"}
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_q2pr26id&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_7nhp83zx%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.19" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_19xrcnne&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_cpcv0a6l%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.20" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
:::{.column-margin}
<div style="max-width:304px"><div style="position:relative;padding-bottom:75.986842105263%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_k1lb9pe7&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_1jn1q0uu%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="304" height="231" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.21" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>

![](_media/memes/weather.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-data-concat chapter=1 description="Concatenating data in pandas" type=💻}

Here we create two frames with three rows each and some commonly named columns:
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_c8600g1g&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_cp0rg8an%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.22" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
...
::::{#exm-data-merge chapter=1 description="Merging data in pandas" type=💻}
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_8brlfsj0&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_nscrt4kn%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.23" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>

![](_media/memes/join.jpg){.lightbox width=200px fig-align="center"}
...
::::{#exm-data-merge-weather chapter=1 description="Merging data" type=💻}
...
Raw data often needs to be manipulated into a usable format before algorithms can be applied. Preprocessing data so that it is suitable for machine analysis is known as **data wrangling**.
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_1yoo56s2&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_0404k1sj%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.25" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

<br></br>
![](_media/memes/missing.jpg){.lightbox width=200px fig-align="center"}
...
To demonstrate algorithms in later sections, we will be using a [dataset describing loans](https://www.kaggle.com/datasets/imsparsh/lending-club-loan-dataset-2007-2011) made on the crowdfunding site LendingClub. For this example, we'll keep only a few columns.
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_2ul0qp9u&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_k056ef0x%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.26" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>

:::

You can look at the [pandas user guide](https://pandas.pydata.org/docs/user_guide/text.html#text-string-methods) for a more thorough demonstration of string methods in pandas.
...
::::{#exm-data-encoding chapter=1 description="Encoding qualitative data" type=💻}
This dataset contains information about diamonds:
...
cuts_cat = pd.Categorical(diamonds["cut"], categories=cuts, ordered=True)  # ordinal
cuts_cat
```
...
::::{#exm-data-dummies chapter=1 description="Dummy variables in pandas" type=💻}
Here is a dataset of NBA player statistics from 2023–2024:
...
:::{.column-margin}
<div style="max-width:400px"><div style="position:relative;padding-bottom:71.25%"><iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/2358381/embedPlaykitJs/uiconf_id/57659783?iframeembed=true&amp;entry_id=1_hu44cer7&amp;config%5Bprovider%5D=%7B%22widgetId%22%3A%221_z9v4qx6l%22%7D&amp;config%5Bplayback%5D=%7B%22startTime%22%3A0%7D" width="400" height="285" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Example 1.28" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0"></iframe></div></div>
