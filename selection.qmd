...
@exm-select-learning-curves showed that a decision tree of depth 3 had a closing gap between scores for training and testing sets as the training set size grew.  Now look at what happens for a much deeper decision tree:
