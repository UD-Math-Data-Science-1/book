...
**(a)** Find the testing recall of a kNN classifier with $k=1$. (The positive outcome is $+1$.)

**(b)** Find the testing recall of a kNN classifier with $k=3$.

**(c)** Find the testing recall of a kNN classifier with $k=9$.
