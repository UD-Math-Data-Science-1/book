...
Now, here is a table of training data:
...
**(b)** Add a row to your table from part (a) showing the predictions of a kNN classifier with $k=1$.

**(c)** Add a row to your table showing the predictions of a kNN classifier with $k=3$. Then add another row for $k=9$.

**(e)** Find the recall for each of the cases $k=1$, $k=3$, and $k=9$.

**(f)** Over all possible training subsets of the original training data, which of the classifiers above would you expect to have the largest training variance? Which would have the smallest?
