...
::::{#exm-stats-maxvar}
Suppose that $x_1=0$, $x_2=t$, and $x_3=-t$, where $|t| \le 5$. What are the minimum and maximum possible values of the standard deviation? 

:::{.solution}
The mean is $\mu=0$, and hence
$$
...
sns.relplot(dozen[dozen["dataset"]=="dino"], x="x", y="y");
```
